 ...
 namespace Valve.VR.InteractionSystem
{
    ...
    public class LinearDrive_Project : MonoBehaviour
    {
        public Transform startPosition;
        public Transform[] endPosition;//modified for array
        public int endArrayPos;// array index
        ...
        // new chance array pos for end points
        public void SetArrayPos(int index)
        {
            endArrayPos = index;
        }
        ...
        protected virtual void Start()
        {
            ...
            if (linearMapping == null)
            {
                linearMapping = gameObject.AddComponent<LinearMapping_project>();
            }
        ...
        protected void UpdateLinearMapping(Transform updateTransform)
        {
            ...
            if (repositionGameObject)
            {
                transform.position = Vector3.Lerp(startPosition.position, endPosition[endArrayPos].position, linearMapping.value);
            }
        }

        protected float CalculateLinearMapping(Transform updateTransform)
        {
            Vector3 direction = endPosition[endArrayPos].position - startPosition.position;
